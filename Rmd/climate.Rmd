...
bs_modal(id = 'OCWA', title = "Orange-crowned Warbler: arriving earlier",
         body = tagList(tags$p("In recent years, Orange-crowned Warblers have tended to arrive earlier than average, changing at a rate of 2.6 days per decade."),
                        tags$img(src = "fig/OCWA_migration.jpg", width = '300px', class = "center"),
...
bs_modal(id = 'SWTH', title = "Swainson's Thrush: no change", 
         body = tagList(tags$p("So far, there has been no detectable change in Swainson's Thrush arrival dates over time."),
                        tags$img(src = "fig/SWTH_migration.jpg", width = '300px', class = "center"),
                        tags$figcaption("Annual arrival dates to Palomarin, 1980-2016")))

bs_modal(id = 'WIWA', title = "Wilson's Warbler: arriving later", 
         body = tagList(tags$p("In recent years, Wilson's Warblers have tended to arrive later than average, changing at a rate of 1.1 days per decade."),
                        tags$img(src = "fig/WIWA_migration.jpg", width = '300px', class = 'center'),
                        tags$figcaption("Annual arrival dates to Palomarin, 1980-2016")))
...
bs_modal(id = 'FOSP', title = "Fox Sparrow: no change", 
         body = tagList(tags$p("So far, there has been no detectable change in Fox Sparrow arrival dates over time."),
                        tags$img(src = "fig/FOSP_migration.jpg", width = '300px', class = "center"),
                        tags$figcaption("Annual arrival dates to Palomarin, 1980-2016")))

bs_modal(id = 'GCSP', title = "Golden-crowned Sparrow: arriving earlier", 
         body = tagList(tags$p("In recent years, Golden-crowned Sparrows have tended to arrive earlier than average, changing at a rate of 2.1 days per decade."),
                        tags$img(src = "fig/GCSP_migration.jpg", width = '300px', class = "center"),
                        tags$figcaption("Annual arrival dates to Palomarin, 1980-2016")))

bs_modal(id = 'HETH', title = "Hermit Thrush: no change", 
         body = tagList(tags$p("So far, there has been no detectable change in Hermit Thrush arrival dates over time."),
                        tags$img(src = "fig/HETH_migration.jpg", width = '300px', class = 'center'),
                        tags$figcaption("Annual arrival dates to Palomarin, 1980-2016")))

bs_modal(id = 'RCKI', title = "Ruby-crowned Kinglet: arriving earlier", 
         body = tagList(tags$p("In recent years, Ruby-crowned Kinglets have tended to arrive earlier than average, changing at a rate of 1.8 days per decade."),
                        tags$img(src = "fig/RCKI_migration.jpg", width = '300px', class = 'center'),
                        tags$figcaption("Annual arrival dates to Palomarin, 1980-2016")))
```
...
<figcaption>
Average temperatures and rainfall recorded at the Palomarin Field Station each year, 1976&ndash;2018. Average temperatures are calculated from the average of the daily high and low temperatures. Rainfall totals are calculated from July through June of the following calendar year, to capture an entire winter rainy season.
</figcaption>
...
The timing of bird arrivals in spring is thought to be adapted to the timing of food availability for successfully raising young, which may also be shifting with climate change. The timing of bird arrivals in fall may reflect warmer temperatures and a longer nesting season to our north. It's not yet clear whether birds that are shifting the timing of their migration are able to keep up with changes in their environment, or why some birds aren't yet changing the timing of migration at all. Future research could examine whether individuals that arrive earlier or later are more successful in raising young or surviving the winter, whether the optimal arrival time has changed over the years, and whether it depends on [how far the birds are migrating](connections.html).
