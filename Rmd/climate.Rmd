...
Point Blue staff collect weather data several times each day at the Palomarin Field Station to understand how short-term fluctuations in weather and long-term changes in climate affect bird populations. Understanding these changes requires long-term monitoring effort across decades!
...
Weather plays a huge role in the daily lives of birds, and is a major driver of everything from successfully raising young, to surviving the winter, to migration timing, and even body size. Here are just a couple examples of how our research has identified how birds are responding to global climate change. 
...
We don't yet know exactly why some species are changing their migration timing while others are not, and whether shifts in migration timing are helping species adapt to changes in the timing of their food supply or other necessary resources. Future research could examine whether individuals that arrive earlier or later are more successful in raising young or surviving the winter, and whether the optimal arrival time has changed over the years.
