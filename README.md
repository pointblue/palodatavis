...
Point Blue’s Palomarin Field Station has been in operation since 1966.
The Data Explorer is a series of web pages that help tell the key
science stories coming out of the long-term data collected at Palomarin
and provide opportunities to access to the field station’s data. This
repository contains the code necessary to produce the interactive
graphics viewable on each page. The graphics themselves are hosted by
Github, and made viewable through an iframe on the Point Blue website.
...
-   [Migratory connectivity
    map](https://pointblue.org/github.io/palodatavis/widget/migration_map.html):
    Does not yet include most recent Golden-crowned Sparrow studies
    (Iverson et al. 2023-2025)

## FUTURE UPDATES

We anticipate that the data available through the Data Explorer website
will be updated intermittently as capacity allows. The Data Explorer
website does not yet fully represent all types of data collected at the
field station or at nearby, related study sites; additional pages or
graphics may be added as capacity allows. Please contact us for
questions about data access and research collaborations.
